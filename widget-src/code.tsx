// This is a counter widget with buttons to increment and decrement the number. Added a button to reset the count back to 0. Dynamically adjusting the width of the widget based on the # of digits.
...
function Widget() {
  ...
  return (
    ...
    >
      ...
      >
        <Text fontSize={32} width={count.toString().length*30} horizontalAlignText={'center'}>
          {count}
        </Text>
        <SVG
          src={`<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M19.75 11C19.75 16.579 15.329 21 9.75 21C4.17101 21 0 16.579 0 11C0 5.42101 4.42101 1 9 1V3.22222C5.37314 3.22222 2.77778 6.11913 2.77778 9.77778C2.77778 13.4364 5.37314 16.3333 9 16.3333C12.6269 16.3333 15.2222 13.4364 15.2222 9.77778H12.4444V7H18.5556V13.1111H16.1111V10.6667H19.75V11Z" fill="#333333"/>
          </svg>`}
          onClick={() =>{
            handleReset()
          }}
